...
if(isset($_POST['email'])) {
    ...
    if ($_POST['region'] == 'Europe') {
        $email_to = "uk@chazeypartners.com";
    } 
    if ($_POST['region'] == 'North America') {
        $email_to = "us@chazeypartners.com";
    }
    if ($_POST['region'] == 'Latin America') {
        $email_to = "mexico@chazeypartners.com";
    }
    if ($_POST['region'] == 'Asia, Middle East & Africa') {
        $email_to = "hongkong@chazeypartners.com";
    } 
    //$email_to = "hello@deluxcode.com";

    $email_subject = "Contact from Chazey's website";
