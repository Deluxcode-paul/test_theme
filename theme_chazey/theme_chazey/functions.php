<?php
/**
 * chazey functions and definitions
 *
...
if ( ! function_exists( 'chazey_setup' ) ) :
/**
 ...
 */
function chazey_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on chazey, use a find and replace
	 * to change 'chazey' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'chazey', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'chazey' ),
    'shared' => esc_html__( 'Shared Services', 'chazey' ),
    'business' => esc_html__( 'Business Transformation', 'chazey' ),
    'security' => esc_html__( 'Enterprise Wide Security', 'chazey' ),
		'footer_menu-1' => esc_html__( 'Footer1', 'chazey' ),
		'footer_menu-2' => esc_html__( 'Footer2', 'chazey' ),
		'footer_menu-3' => esc_html__( 'Footer3', 'chazey' ),
	) );
...
class Child_Wrap extends Walker_Nav_Menu
{
   ...
   function end_lvl(&$output, $depth)
   {
	...
	add_theme_support( 'custom-background', apply_filters( 'chazey_custom_background_args', array(
...
add_action( 'after_setup_theme', 'chazey_setup' );
 ...
 */
function chazey_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'chazey_content_width', 640 );
}
add_action( 'after_setup_theme', 'chazey_content_width', 0 );
 ...
 */
function chazey_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'chazey' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'chazey' ),
...
add_action( 'widgets_init', 'chazey_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function chazey_scripts() {
	wp_enqueue_style( 'chazey-style', get_stylesheet_uri() );

	wp_enqueue_script( 'chazey-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'chazey-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
add_action( 'wp_enqueue_scripts', 'chazey_scripts' );
...
function events_init() {
	$labels = array(
		'name'               => _x( 'Events', 'team', 'chazey' ),
		'singular_name'      => _x( 'Events', 'team', 'chazey' ),
		'menu_name'          => _x( 'Events', 'admin menu', 'chazey' ),
		'name_admin_bar'     => _x( 'Events', 'add new on admin bar', 'chazey' ),
		'add_new'            => _x( 'Add New', 'Event', 'chazey' ),
		'add_new_item'       => __( 'Add New Event', 'chazey' ),
		'new_item'           => __( 'New Event', 'chazey' ),
		'edit_item'          => __( 'Edit Event', 'chazey' ),
		'view_item'          => __( 'View Event', 'chazey' ),
		'all_items'          => __( 'All Events', 'chazey' ),
		'search_items'       => __( 'Search Events', 'chazey' ),
		'parent_item_colon'  => __( 'Parent Events:', 'chazey' ),
		'not_found'          => __( 'No teams found.', 'chazey' ),
		'not_found_in_trash' => __( 'No teams found in Trash.', 'chazey' )
	);

	$args = array(
		'labels'             => $labels,
        'description'        => __( 'Description.', 'chazey' ),
		'public'             => true,
		'publicly_queryable' => true,
		'show_ui'            => true,
		'show_in_menu'       => true,
...
function webinars_init() {
	$labels = array(
		'name'               => _x( 'Webinars', 'team', 'chazey' ),
		'singular_name'      => _x( 'Webinars', 'team', 'chazey' ),
		'menu_name'          => _x( 'Webinars', 'admin menu', 'chazey' ),
		'name_admin_bar'     => _x( 'Webinars', 'add new on admin bar', 'chazey' ),
		'add_new'            => _x( 'Add New', 'Webinar', 'chazey' ),
		'add_new_item'       => __( 'Add New Webinar', 'chazey' ),
		'new_item'           => __( 'New Webinar', 'chazey' ),
		'edit_item'          => __( 'Edit Webinar', 'chazey' ),
		'view_item'          => __( 'View Webinar', 'chazey' ),
		'all_items'          => __( 'All Webinars', 'chazey' ),
		'search_items'       => __( 'Search Webinars', 'chazey' ),
		'parent_item_colon'  => __( 'Parent Webinars:', 'chazey' ),
		'not_found'          => __( 'No teams found.', 'chazey' ),
		'not_found_in_trash' => __( 'No teams found in Trash.', 'chazey' )
	);
