...
get_header(); ?>
    ...
    <section class="shared-services-more__clients">
        ...
        <?php query_posts('post_type=clients_init&clientcat=procurement&post_status=publish'); ?>
                ...
                <?php while( have_posts() ): the_post(); ?>
                    ...
                    <style>
                        .brand_logo_<?php echo $counter; ?> {
                            background: url(<?php the_field('image_clogo'); ?>) center center no-repeat;
                        }
                        .brand_logo_<?php echo $counter; ?>:hover {
                            background: #0099cc url(<?php the_field('image_clogo_hover'); ?>) center center no-repeat;
                        }
                    </style>
